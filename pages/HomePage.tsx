      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="rounded-full bg-brand-primary/10 px-3 py-1 text-xs font-semibold text-brand-primary">Beta</span>
          </div>
          <button
        ...
        <div className="mt-12 rounded-3xl bg-gradient-to-r from-violet-600 via-brand-primary to-sky-500 p-8 text-white shadow-xl">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-white/80">Featured course</p>
          <h1 className="mt-4 text-3xl font-bold md:text-4xl">NEET 2025 Prep Course</h1>
          <p className="mt-4 max-w-2xl text-sm text-white/80 md:text-base">
            New batches starting soon. Get personalised mentorship, adaptive mock tests, and daily practice sprints crafted by top mentors.
          </p>
        ...
        <section className="mt-16 grid gap-6 md:grid-cols-3">
          {sellingPoints.map((point) => (
            ...
            >
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-brand-primary">Why learners love it</p>
              <h2 className="mt-2 text-xl font-semibold text-slate-900 dark:text-white">{point.title}</h2>
