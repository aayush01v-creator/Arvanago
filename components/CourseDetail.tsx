      ...
      <section className="relative grid gap-10 lg:grid-cols-[2fr,1fr]">
        ...
        <aside className="space-y-6">
          ...
          {suggestedCourses.length > 0 && (
            <div className="overflow-hidden rounded-3xl border border-white/60 bg-white/85 p-6 shadow-[0_18px_60px_rgba(15,23,42,0.12)] backdrop-blur-2xl transition-colors duration-500 dark:border-white/5 dark:bg-slate-900/75 dark:shadow-[0_28px_70px_rgba(2,6,23,0.5)]">
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Suggested for you</h3>
              ...
              <div className="mt-5 space-y-4">
                {suggestedCourses.map((suggested) => (
                  <button
                    ...
                    className="group flex w-full items-center gap-4 rounded-2xl border border-white/60 bg-white/70 p-3 text-left shadow-sm transition-all duration-500 hover:-translate-y-0.5 hover:border-brand-primary/40 hover:bg-white dark:border-white/10 dark:bg-white/5"
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <p className="font-semibold text-slate-900 transition-colors duration-500 group-hover:text-brand-primary dark:text-white">
                            {suggested.title}
                          </p>
